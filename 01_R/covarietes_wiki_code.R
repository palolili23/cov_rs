...
rs1_1 <- import("V:/Uitwissel/Paloma/Data/Visits/Ergo1ResponseDetail_(22-jan-2015)_excerpt.sav")
rs1_2 <- import("V:/Uitwissel/Paloma/Data/Visits/Ergo2ResponseDetail_(22-jan-2015)_excerpt.sav")
rs1_3 <- import("V:/Uitwissel/Paloma/Data/Visits/e3_(3)_RESPONS_(22-feb-2016)_excerpt.sav")
rs1_4 <- import("V:/Uitwissel/Paloma/Data/Visits/e4_(4)_RESPONS_(12-mar-2018)_excerpt.sav")
rs1_5 <- import("V:/Uitwissel/Paloma/Data/Visits/e5_(5)_RESPONS_(22-jun-2016)_excerpt.sav")
rs1_6 <- import("V:/Uitwissel/Paloma/Data/Visits/e6_(6)_RESPONS_(10-feb-2017)_EXCERPT.sav")
rs2_1 <- import("V:/Uitwissel/Paloma/Data/Visits/ep_(1)_RESPONS_(15-jan-2019)_excerpt.sav")
rs3_1 <- import("V:/Uitwissel/Paloma/Data/Visits/ej_(1)_RESPONS_(04-apr-2016)_excerpt.sav")
...
basic <- import("V:/HomeDir/040609(Paloma Rojas)/My Documents/Projects/HRT and dementia/Handleiding Erasmus MC Werkplek.lnk.sav")
...
# Export wide or long -------------------------------------------------------------
export(complete_db, "V:/Uitwissel/Paloma/Data/db/db_wide.RData")
